...
class PhantomCreator(composer.Entity):

    def _build(self):
        ''' Builds the entity by adding its required child entities.
        EXAMLPE:
        self._mjcf_root = mjcf.from_file(phantom_xml_path,
